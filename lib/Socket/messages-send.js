...
if (!isNewsletter && buttonType) {
  ...
  const filteredButtons = typeof WABinary_1.getBinaryFilteredButtons === 'function'
    ? WABinary_1.getBinaryFilteredButtons(additionalNodes ?? [])
    : null;
...
if (isPrivate) {
  ...
  const filteredBizBot = Array.isArray(additionalNodes)
    ? additionalNodes.find(n => n.tag === "bot" && n.attrs?.biz_bot === "1")
    : null;
